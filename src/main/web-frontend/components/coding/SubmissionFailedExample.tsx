...
import type {SubmissionFailedExample_example$key} from "__generated__/SubmissionFailedExample_example.graphql";
import {formatTestCaseJson} from "./formatTestCaseJson";

type Props = {
  example: SubmissionFailedExample_example$key;
};
...
export default function SubmissionFailedExample(props: Props) {
