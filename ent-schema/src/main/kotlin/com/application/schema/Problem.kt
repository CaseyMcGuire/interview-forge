...
class Problem : EntSchema("problems", clientName = "problems") {
  ...
  val checkerKind by enum<ProblemCheckerKind>("checker_kind").default(ProblemCheckerKind.EXACT_JSON)
  ...
  val createdBy by belongsTo<User>("created_by").field(createdByUserId).onDelete(OnDelete.RESTRICT)
