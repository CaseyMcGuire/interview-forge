...
`KotlinLanguageExecutionConfig` is the first implementation and is registered as a Spring component.
...
The runner will resolve `execution.runtimes[executionConfig.key]`, as specified in
